...
class WebsocketRocketBot(RocketBot):
    ...
    def _handle_room_event(self, message):
        self.logger.debug("Unhandled room event: {}".format(message))
        # TODO: Pick up new channels/groups/ims we've been added to by snooping here
        pass
